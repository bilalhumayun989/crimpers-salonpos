...
<head>
    ...
    <title>Forgot Password — The Crimpers</title>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;font-family:'Outfit',sans-serif;}
        ...
        .f-group{margin-bottom:18px;width:100%;}
        ...
        .btn-send{width:100%;padding:13px;background:linear-gradient(135deg,var(--y1),var(--yd));border:none;border-radius:11px;color:#18181b;font-size:.95rem;font-weight:700;cursor:pointer;font-family:'Outfit',sans-serif;box-shadow:0 4px 14px rgba(199,168,0,.3);transition:.2s;}
        .btn-send:hover{transform:translateY(-1px);box-shadow:0 6px 20px rgba(199,168,0,.4);}

        .status-box{background:var(--ybg);border:1.5px solid #f0e8b0;border-radius:10px;padding:12px 14px;margin-bottom:20px;color:var(--yk);font-size:.83rem;font-weight:600;display:flex;align-items:center;gap:8px;width:100%;}
...
<body>
    <div class="auth-left">
        <div class="auth-left-content">
            ...
            <div class="auth-brand-sub">Enter your email and we'll send you a secure link to reset your password.</div>
        </div>
    </div>
    ...
    <div class="auth-right">
        <div class="form-header">
            <div class="form-header-icon">
                <svg width="24" height="24" fill="none" stroke="#18181b" stroke-width="2.5" viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
            </div>
            <h2>Forgot Password?</h2>
            <p>No worries — enter your email address and we'll send you a recovery link.</p>
        </div>
        ...
        <form action="{{ route('password.email') }}" method="POST" style="width:100%;">
            ...
            <button type="submit" class="btn-send">
                <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" style="display:inline;vertical-align:middle;margin-right:5px;"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
                Send Recovery Link
            </button>
        </form>
