...
<div class="form-wrap">
    <div class="form-header">
        ...
        <div>
            <div class="form-title">New Package</div>
            <div class="form-sub">Bundle services together with a custom price</div>
        </div>
    </div>
    ...
    <div class="form-card">
        <form action="{{ route('packages.store') }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="f-grid-2" style="margin-bottom:14px;">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required class="f-input" placeholder="e.g. Full Glam Package">
                    </div>
                    <div>
                ...
                <div class="f-grid-2" style="margin-bottom:14px;">
                    <div>
                        ...
                        <input type="number" min="1" name="duration" value="{{ old('duration',60) }}" required class="f-input" placeholder="60">
                    </div>
                ...
                <div>
                    ...
                    <textarea name="description" class="f-input" placeholder="Describe what's included in this package…">{{ old('description') }}</textarea>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="svc-check-grid">
                    ...
                    <label class="svc-check-item">
                        <input type="checkbox" name="service_ids[]" value="{{ $svc->id }}" {{ in_array($svc->id, old('service_ids',[])) ? 'checked' : '' }}>
                        <div>
            ...
            <div class="form-footer">
                ...
                <button type="submit" class="btn-save">Create Package</button>
            </div>
        </form>
    </div>
</div>
