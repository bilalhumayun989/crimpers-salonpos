...
.btn-save:hover{transform:translateY(-1px);box-shadow:0 5px 14px rgba(247,223,121,.4);}
...
.modal-box{background:#fff;border:1.5px solid #f0e8a0;border-radius:18px;width:100%;max-width:360px;padding:24px;box-shadow:0 20px 50px rgba(0,0,0,.1);}
.modal-title{font-size:1.1rem;font-weight:800;color:#18181b;margin-bottom:8px;}
.modal-sub{font-size:.8rem;color:#71717a;margin-bottom:18px;}
...
.btn-m-cancel{background:#f4f4f5;color:#71717a;}
.btn-m-save{background:var(--y1);color:var(--ydark);}
...
.toast{min-width:280px;background:#fff;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px;box-shadow:0 10px 25px rgba(0,0,0,.15);border:1px solid var(--y1);transform:translateX(100%);transition:.3s cubic-bezier(0.68, -0.55, 0.265, 1.55);pointer-events:auto;}
...
.ti-success{background:var(--y2);color:var(--ydark);}
.ti-error{background:#fee2e2;color:#dc2626;}
.toast-msg{font-size:.85rem;font-weight:600;color:#18181b;}
...
<form method="POST" action="{{ route('products.store') }}">
    ...
    <div class="form-card">
        ...
        <div class="form-section">
                ...
                <div>
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px;">
                        ...
                        <div style="display:flex;gap:12px;">
                            <button type="button" onclick="showCatModal()" style="font-size:.65rem;font-weight:800;color:var(--ydark);background:none;border:none;cursor:pointer;padding:0;">+ Add New</button>
                            <button type="button" id="delete_cat_btn" onclick="deleteSelectedCat()" style="font-size:.65rem;font-weight:800;color:#ef4444;background:none;border:none;cursor:pointer;padding:0;">- Delete Selected</button>
                        </div>
                    </div>
            ...
            <div class="f-row">
                <label class="f-label">Description <span style="color:#a1a1aa;font-weight:400;">(optional)</span></label>
        ...
        <div class="form-section">
            ...
            <div class="f-grid-3" style="margin-bottom:14px;">
                <div>
                    ...
                    <input type="number" name="selling_price" min="0" step="0.01" required class="f-input" placeholder="0.00">
                </div>
                <div>
                    <label class="f-label">Cost Price (PKR)</label>
                    <input type="number" name="cost_price" min="0" step="0.01" class="f-input" placeholder="Purchase cost">
                </div>
                <div>
            ...
            <div class="f-grid-2" style="margin-bottom:14px;">
                <div>
                    ...
                    <input type="number" name="min_stock_level" min="0" step="1" class="f-input" placeholder="Low stock threshold">
                </div>
                <div>
...
<div class="modal-overlay" id="delCatModal">
    <div class="modal-box delete-confirm">
        ...
        <div class="modal-sub" id="del_msg_text">Are you sure you want to delete this category? All products in it will be affected.</div>
        <div class="m-footer">
