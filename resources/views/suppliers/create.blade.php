...
.err{font-size:.72rem;color:#dc2626;margin-top:4px;}
...
.btn-save:hover{transform:translateY(-1px);box-shadow:0 5px 16px rgba(247,223,121,.4);}
</style>
...
<div class="form-wrap">
    <div class="form-header">
        ...
        <div>
            <div class="pg-title">New Supplier</div>
            <div class="pg-sub">Register a new vendor or supply partner</div>
        </div>
    </div>
        ...
        <form action="{{ route('suppliers.store') }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="f-row">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="f-input" placeholder="e.g. Prestige Beauty Supplies">
                    @error('name')<div class="err">{{ $message }}</div>@enderror
                </div>
                <div class="f-row">
                    <label class="f-label">Address</label>
                    <textarea name="address" class="f-input" placeholder="Full registered address…">{{ old('address') }}</textarea>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="f-grid-2">
                    <div>
                        ...
                        <input type="text" name="contact_person" value="{{ old('contact_person') }}" class="f-input" placeholder="Full name">
                    </div>
                    <div>
                        <label class="f-label">Phone Number</label>
                        <input type="tel" name="phone" value="{{ old('phone') }}" class="f-input" placeholder="+92 300 1234567">
                    </div>
                </div>
                <div class="f-row" style="margin-bottom:0;">
                    <label class="f-label">Email Address</label>
                    <input type="email" name="email" value="{{ old('email') }}" class="f-input" placeholder="vendor@example.com">
                </div>
            </div>
            ...
            <div class="form-footer">
                ...
                <button type="submit" class="btn-save">Create Supplier</button>
            </div>
        </form>
    </div>
</div>
